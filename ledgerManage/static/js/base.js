...
//页面所有按钮点击样式变化
base.icon = function(){
    $(document).on('mousedown','.item-btn,.tools-btn,.del,.selectBtn,.submitted,.sure,.payed',function(){
        $(this).css('background-color','#67a4e6');
    })
    $(document).on('mouseup','.item-btn,.tools-btn,.del,.selectBtn,.submitted,.sure,.payed',function(){
